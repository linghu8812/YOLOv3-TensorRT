...
def main(cfg_file='yolov3.cfg', weights_file='yolov3.weights', output_file='yolov3.onnx'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='yolov3.cfg', help='yolo cfg file')
    parser.add_argument('--weights_file', type=str, default='yolov3.weights', help='yolo weights file')
    parser.add_argument('--output_file', type=str, default='yolov3.onnx', help='yolo onnx file')
    args = parser.parse_args()
    main(cfg_file=args.cfg_file, weights_file=args.weights_file, output_file=args.output_file)
